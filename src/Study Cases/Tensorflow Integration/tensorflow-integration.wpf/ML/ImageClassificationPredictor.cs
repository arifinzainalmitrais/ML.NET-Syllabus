...
using tensorflow_integration.wpf.ML.Base;
using tensorflow_integration.wpf.ML.Objects;

using Microsoft.ML;

namespace tensorflow_integration.wpf.ML
{
    public class ImageClassificationPredictor : BaseML
    {
        ...
        private static readonly string ML_NET_MODEL = Path.Combine(Environment.CurrentDirectory, "tensorflow_integration.mdl");
